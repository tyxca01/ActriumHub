...
if placeIdStr == "2753915549" or placeIdStr == "79091703265657" or placeIdStr == "100117331123089" then
    loadstring(game:HttpGet("https://api.cipher.pink/l/actriumhub-bf.lua", true))()
elseif gameId == 10200395747 then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/tyxca01/ActriumHub/refs/heads/main/GrowGarden2..lua"))()
else
